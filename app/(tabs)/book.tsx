...
export default function TabOneScreen() {
  ...
  return (
    <ParallaxScrollView
      ...
      {
        data.map((_, i) => {
          return <ThemedView className="h-50 active:bg-gray-500 bg-gray-100 dark:bg-gray-700 dark:text-white-100 rounded px-1 py-1 h-24 -mx-4  shadow-lg shadow-cyan-500/50 dark:shadow-lg" key={i} >
